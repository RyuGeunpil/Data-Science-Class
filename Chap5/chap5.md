...
- **2차원 빈도분석:** 2개 범주형 변수에 대한 빈도 분석을 실시 <br>

**교차표 만들기:** addmargin() 함수를 통해 2개 범주형 변수의 하위 범주에 대한 전체 빈도를 총합 계산함. addmargin() 함수를 통해 총계 표현
...
**교차 비율표 만들기:** prop.table 함수를 통해 2개 범주형 변수의 하위 범주에 대한 비율을 통합적으로 계산함. addmargin() 함수를 통해 총비율 표현
```
